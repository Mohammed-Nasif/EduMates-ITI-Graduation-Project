      ...
      <div className='about_instructor py-3 text-center px-4 '>
        ...
        <div className='about_box  m-auto p-2 '>
          <p className='m-0'>
            ...
            Python, .Net Technologies, API and other related technologies.
            Following his BSc. in civil engineering, He has got the 9-month
            diploma of Information Technology Institute. He has majored in the
