...
export const Coursescategories = props => {
  let topics = [
    'java script',
    'css',
    'problem solving',
...
console.log(props.setAllCourses());
  function sorting (e) {
    if (e.target.id === 'moreLessons') {
      props.allCourses.sort(
        (a, b) => b.lessonsList.length - a.lessonsList.length
      )
	props.setAllCourses(props.allCourses)
    } else if (e.target.id === 'lessLessons') {
      props.allCourses.sort(
        (a, b) => a.lessonsList.length - b.lessonsList.length
      )
	  props.setAllCourses(props.allCourses)
    }
  }
