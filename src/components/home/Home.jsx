        ...
        <Navbar bg='transparent' expand='lg' className='mt-3'>
          ...
          <Navbar.Collapse id='basic-navbar-nav'>
            <Nav className='ms-auto'>
              <Nav.Link className='  fs-5  btn btn-outline-info fw-bold mx-2 px-3 my-sm-3'>
                sign up
              </Nav.Link>
              <Nav.Link className=' fs-5  btn btn-outline-info fw-bold  mx-2 px-4 my-sm-3'>
                log in
              </Nav.Link>
            </Nav>
          </Navbar.Collapse>
          ...
          <div className='row align-items-center justify-content-between'>
            ...
            <div className='col-md-5'>
              <div className=' section-text py-sm-5'>
                <p>
                  As we have strong belief that education is the key for better
                  future. Our website is a social media platform that encourage
                  users to get involved in education process either by giving
                  courses or enrolling in courses.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className='row justify-content-between align-items-center'>
            <div className='col-md-5 py-sm-3'>
              <div className='section-text '>
                <p>
                  <span className='text-primary fw-bold fs-3'>Edu</span> Mates
                  website provide users a community to engage with their
                  environments. And as we believe that communities develop
                  through education our website has educational side that
                  facilitates educational process to our users through courses
                  and other features.
                </p>
              </div>
            </div>
          ...
          <div className='row align-items-center justify-content-between'>
            ...
            <div className='col-md-5'>
              <div className='preview_text  text-sm-center '>
                ...
                <p className='fs-5'>
                  In the age of Epidemics, the importance of remote
                  communication has significantly aroused. Getting people closer
                  despite of physical distancing. Business, Marketing ,
                  Education, even health consultations are done over the
                  internet
                </p>
              </div>
            </div>
